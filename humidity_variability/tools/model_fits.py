...
def fit_zero_knots(df_use, this_q):
...
def fit_one_knot(df_use, N, this_q, BIC_prior):
    ...
    return BIC, delta_bic, res, f


def fit_two_knots(df_use, N, this_q, BIC_prior):
    """Fit QR model with a single knot.
...
def fit_three_knots(df_use, N, this_q, BIC_prior):
    """Fit QR model with a single knot.
