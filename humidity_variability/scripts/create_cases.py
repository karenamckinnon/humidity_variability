...
if __name__ == '__main__':
    ...
    parser.add_argument('rho', type=float, help='Autocorrelation coefficient (daily)')
    ...
    fit_case(int(args.this_case), qs, float(args.rho), lambd_values, args.boot_start, args.nboot,
